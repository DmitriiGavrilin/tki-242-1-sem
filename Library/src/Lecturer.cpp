...
Lecturer::Lecturer(int id, const std::string& name, const std::string& category, const std::string& owner,
...
std::string Lecturer::type() const { return "Lecturer"; }
...
const std::string& Lecturer::detail() const noexcept { return detail_; }
}
